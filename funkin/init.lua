...
require "funkin.backend.modding.scripts.events"
...
Script = require "funkin.backend.modding.scripts"
ScriptsHandler = require "funkin.backend.modding.scripts.handler"
